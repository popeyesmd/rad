/*
 * JS for CarePass_ErrorPopUp generated by Appery.io
 *
 */
...
CarePass_ErrorPopUp_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobilelabel1_2': 'CarePass_ErrorPopUp_mobilelabel1_2'
    };
    ...
    Appery.CurrentScreen = 'CarePass_ErrorPopUp';
    ...
    // Before Show
    CarePass_ErrorPopUp_beforeshow = function() {
        Appery.CurrentScreen = "CarePass_ErrorPopUp";
    ...
    // On Load
    screen_4486_onLoad = CarePass_ErrorPopUp_onLoad = function() {
        screen_4486_elementsExtraJS();

        // TODO fire device events only if necessary (with JS logic)
        CarePass_ErrorPopUp_deviceEvents();
        CarePass_ErrorPopUp_windowEvents();
        screen_4486_elementsEvents();
    }

    // screen window events
    screen_4486_windowEvents = CarePass_ErrorPopUp_windowEvents = function() {

        $('#CarePass_ErrorPopUp').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#CarePass_ErrorPopUp').bind({
            pagehide: function() {
    ...
    // device events
    CarePass_ErrorPopUp_deviceEvents = function() {
    ...
    screen_4486_elementsExtraJS = CarePass_ErrorPopUp_elementsExtraJS = function() {
        // screen (CarePass_ErrorPopUp) extra code

    }

    // screen elements handler
    screen_4486_elementsEvents = CarePass_ErrorPopUp_elementsEvents = function() {
    ...
    $("#CarePass_ErrorPopUp").die("pagebeforeshow").live("pagebeforeshow", function(event, ui) {
        CarePass_ErrorPopUp_beforeshow();
    });

    if (runBeforeShow) {
        CarePass_ErrorPopUp_beforeshow();
    } else {
        CarePass_ErrorPopUp_onLoad();
    }

}

$("#CarePass_ErrorPopUp").die("dialoginit").live("dialoginit", function(event, ui) {
    Appery.processSelectMenu($(this));
    CarePass_ErrorPopUp_js();
});

$("#CarePass_ErrorPopUp").die("dialogcreate").live("dialogcreate", function(event, ui) {
