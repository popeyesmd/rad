/*
 * JS for load generated by Appery.io
 *
 */
...
load_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobileimage_4': 'load_mobileimage_4'
    };
    ...
    // On Load
    screen_BEC1_onLoad = load_onLoad = function() {
        screen_BEC1_elementsExtraJS();

        // TODO fire device events only if necessary (with JS logic)
        load_deviceEvents();
        load_windowEvents();
        screen_BEC1_elementsEvents();
    }

    // screen window events
    screen_BEC1_windowEvents = load_windowEvents = function() {

        $('#load').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    screen_BEC1_elementsExtraJS = load_elementsExtraJS = function() {
        // screen (load) extra code

    }

    // screen elements handler
    screen_BEC1_elementsEvents = load_elementsEvents = function() {
    ...
    $("#load").die("pagebeforeshow").live("pagebeforeshow", function(event, ui) {
        load_beforeshow();
    });
...
$("#load").die("pageinit").live("pageinit", function(event, ui) {
